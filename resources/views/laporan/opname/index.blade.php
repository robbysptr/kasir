...
@section('title')
    Laporan Daftar Stok Opname Barang
@endsection
        ...
        <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading with-border">
                        <h3 class="panel-title"><i class="fa fa-list"></i> Laporan Cetak Daftar Opname Barang</h3>
                    </div>
                    ...
                    <div class="panel-body pad table-responsive">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-horizontal">
                                <div class="form-group">
                                    {!! Form::open(['url' => '/cetakopname', 'method'=>'POST', 'id'=>'formcetak']) !!}
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTableBuilder">
                            ...
                            <tr>
                                ...
                                <th class="col-md-1" style="background-color:#73b4ff;">Stok</th>
                                <th class="col-md-1" style="background-color:#59e0c5;">Nyata</th>
                                <th class="col-md-1" style="background-color:#ff869a;">Selisih</th>
