...
<head>
    ...
    <title>Laporan Daftar Retur Barang</title>
</head>
...
<div id="header">
    <table width="100%" style="margin-top: 10px">
        <tr>
            <td class="judul_laporan">LAPORAN DAFTAR RETUR BARANG</td>
        </tr>
        <tr>
...
<table id="dataTableBuilder" class="table table-striped table-bordered table-hover display select tg"
    ...
    @foreach($retur as $i => $value)
        <tr>
            ...
            <td style="width: 13%; text-align: right;" class="tg-rv4w">{{ number_format($value->total(), 0, ',', '.') }}</td>
