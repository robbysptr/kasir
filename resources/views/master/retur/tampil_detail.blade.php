...
<section class="content">
    ...
    <div class="panel panel-warning">
        <h3 class="panel panel-heading">
            <i class="fa fa-shopping-cart"></i> Detail Retur
        </h3>
        <div class="panel panel-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 ml-2">
                    {!! Form::hidden('idpenjualan', $retur->penjualan_id, ['id'=>'idpenjualan', 'class' => 'form-control'])!!}
                    <b>Kasir : {{ $retur->user->name}}</b><br>
                    <b>Tanggal :</b> {{ date('d-m-Y', strtotime($retur->tgl_retur)) }} <br>
                    <b>Jam :</b> {{ date('H:i:s', strtotime($retur->created_at)) }} <br>
                    <b>Alamat :</b> Jl. Ronggolawe Ds. Bogem Kec. Gurah Kediri
                </div>
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                    <b>No. Invoice: <span class="label label-warning"> {{ $retur->penjualan->no_invoice }} </span></b><br>
                    <b>No. Retur: <span class="label label-success"> {{ $retur->no_retur }} </span></b><br>
                    <b>Order ID:</b> {{ $retur->id }} <br>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <a id="kembali" href="{{ url('listretur') }}" class="btn btn-primary"><i class="fa fa-refresh"></i> Kembali</a>
                </div>
            </div>
        </div>
    </div>
