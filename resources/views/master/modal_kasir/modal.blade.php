    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Ubah Uang Modal Kasir</h4>
            </div>
            <div class="modal-body">
                <input type="hidden" id="idubah">
                @include('master.modal_kasir.form-ubah')
            </div>
...
<div class="modal fade" id="modalLihat" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">Detail Uang Modal Kasir</h4>
            </div>
            <div class="modal-body">
                <input type="hidden" id="idubah">
                @include('master.modal_kasir.form-lihat')
            </div>
            <div class="modal-footer">
